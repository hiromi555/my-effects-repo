import"./modulepreload-polyfill-B5Qt9EMX.js";import{G as h}from"./GLTFLoader-C6mNuhKw.js";import{s as y,a as p,c as b,d as w,b as U,u as d}from"./raycasterHelper-BKYk4TAk.js";import{s as T}from"./scrollObserver-BS9xrVi3.js";import{d as R,T as _,a as C,D as L,C as M}from"./three.module-BS1B3NZB.js";var I=`uniform float uTime;
varying vec2 vUv;
void main(){
...
}`;const D="/my-effects-repo/assets/bg2-DDmhCEDH.jpg",S="/my-effects-repo/assets/phone-CM7HMWfN.glb",e=document.createElement("canvas"),c=e.getContext("2d");c.translate(e.width,0);c.scale(-1,1);c.fillStyle="black";c.fillRect(0,0,e.width,e.height);c.font="22px sans-serif";c.fillStyle="white";c.textAlign="center";c.textBaseline="middle";c.fillText("画面タップで",e.width/2,e.height/4.25);c.fillText("スクリーンセーバーを",e.width/2,e.height/2.5);c.fillText("切り替え",e.width/2,e.height/1.8);c.fillText("スクロールで消去",e.width/2,e.height/1.25);const k=new R(e),P=600,K=new _,H=K.load(D),O=T(".myeffect-target-class"),t=b(P),{scene:l,renderer:i}=y("canvas.myeffect-webgl"),v=p(l,t);function z(){const n=new L(16777215,100);n.position.set(10,-3,7),l.add(n)}const{getIntersections:m}=w(l),N=new h;let a=0;const j=4,s=new C({vertexShader:I,fragmentShader:E,uniforms:{uTime:{value:0},uTexture:{value:H},uMessageTexture:{value:k},uIsClicked:{value:!1},colorIndex:{value:a}}});let o,u;function A(){N.load(S,n=>{o=n.scene,o.rotation.y=-.4,u=o.children[0].children[3],u.material=s,d(o,t.scaleRatio,t.aspectRatio,[1,1.2]),l.add(o),F()},void 0,n=>{console.error("An error occurred loading the model:",n)})}function F(){window.addEventListener("mousemove",f),window.addEventListener("touchmove",f),window.addEventListener("click",J),window.addEventListener("resize",x)}function f(n){const r=m(n,v);document.body.classList.toggle("myeffect-pointer",r.length>0)}function J(n){m(n,v).length>0&&(s.uniforms.uIsClicked.value=!0,a=(a+1)%j,s.uniforms.colorIndex.value=a)}function x(){t.width=window.innerWidth,t.height=window.innerHeight,v.aspect=t.width/t.height,v.updateProjectionMatrix(),i.setSize(t.width,t.height),i.setPixelRatio(Math.min(window.devicePixelRatio,2)),d(o,t.scaleRatio,t.aspectRatio,[1,1.2])}const W=new M;function g(){const n=W.getElapsedTime();s.uniforms.uTime.value=n,O()&&i.render(l,v),window.requestAnimationFrame(g)}function G(){x(),U(i,t),z(),A(),g()}G();
